...
// Plugin constants.
define('SWISH_BACKUP_VERSION', '1.0.16');
...
define('SWISH_BACKUP_FREE_SIZE_LIMIT', 2147483648); // 2GB in bytes.
define('SWISH_BACKUP_PRO_URL', 'https://swishbackup.swishfolio.com/');
